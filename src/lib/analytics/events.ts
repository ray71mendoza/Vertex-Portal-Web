...
export type AnalyticsVendor = 'vercel' | 'ga4' | 'clarity' | 'linkedin' | 'googleAds' | 'meta';

type Gate = 'YES' | 'A' | 'M' | 'NO';

/**
 * EVENT / PROVIDER MATRIX
 * YES = always sent (Vercel is cookieless/anonymous)
...
export const EVENT_PROVIDER_MATRIX: Record<AnalyticsEventName, Record<AnalyticsVendor, Gate>> = {
  page_view: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'M', meta: 'M' },
  service_view: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'NO', meta: 'M' },
  project_view: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'NO', meta: 'M' },
  contact_cta_click: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'NO', meta: 'M' },
  project_cta_click: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'NO', meta: 'M' },
  email_click: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  phone_click: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  contact_form_start: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  contact_form_submit: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'M', googleAds: 'M', meta: 'M' },
  careers_view: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  job_view: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  job_application_start: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
  job_application_submit: { vercel: 'YES', ga4: 'A', clarity: 'A', linkedin: 'NO', googleAds: 'NO', meta: 'NO' },
};
