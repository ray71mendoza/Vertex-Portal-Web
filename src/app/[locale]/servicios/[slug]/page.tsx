...
export async function generateMetadata({
  ...
  const metaTitle = titles[service.id]?.[currentLocale] || 'Servicio Especializado';
...
export default async function ServicioDetailPage({
  ...
  const breadcrumbItems = [
    ...
    {
      name: service.capabilities[currentLocale]?.[0] || 'Servicio',
      ...
      <JsonLd
        data={[
          ...
          getServiceSchema(
            service,
            currentLocale,
            service.capabilities[currentLocale]?.[0] || 'Servicio Vertex',
